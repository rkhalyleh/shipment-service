$(function() {
	$.widget( "ui.userhealthinfo", {
		options: {
			value: 0
		},
		_create: function() {
			// Create the structure
			this.element.addClass("view-userhealthinfo-ref");
			var mainTable = $('<table cellspacing="15" width="600px"></table>').addClass('main-table');
			var row0 = getEmptyRow();
			row0.append(getTitleColumn("Get User health info"));
	    ...
	    _destroy: function() {
	    	this.element.removeClass("view-userhealthinfo-ref").text("");
	    }
	});
});
